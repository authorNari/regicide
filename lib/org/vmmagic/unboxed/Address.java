...
public final class Address {
  ...
  public Address(ArchitecturalWord value) {
    this.value = value;
  }
  ...
  public static Address zero() {
    return new Address(ArchitecturalWord.zero());
  }
  ...
  public static Address max() {
    return new Address(ArchitecturalWord.max());
  }
  ...
  private ArchitecturalWord loadArchitecturalWord(Offset offset) {
    return this.plus(offset).value.getWord();
  }
  ...
  public boolean attempt(int old, int val) {
    return this.value.exchangeInt(old, val);
  }
  ...
  public boolean attempt(long old, long val) {
    return this.value.exchangeLong(old, val);
  }
  ...
  public boolean attempt(Word old, Word val) {
    return this.value.exchangeWord(old.value, val.value);
  }
